...
LEAN_POD_RWBYTES_INST(Pod_Int8, int8_t, lean_pod_Int8, lean_pod_Int8_box, lean_pod_Int8_toRepr, lean_pod_Int8_fromRepr)
LEAN_POD_RWBYTES_INST(Pod_Int16, int16_t, lean_pod_Int16, lean_pod_Int16_box, lean_pod_Int16_toRepr, lean_pod_Int16_fromRepr)
LEAN_POD_RWBYTES_INST(Pod_Int32, int32_t, lean_pod_Int32, lean_pod_Int32_box, lean_pod_Int32_toRepr, lean_pod_Int32_fromRepr)
LEAN_POD_RWBYTES_INST(Pod_Int64, int64_t, lean_pod_Int64, lean_pod_Int64_box, lean_pod_Int64_toRepr, lean_pod_Int64_fromRepr)
